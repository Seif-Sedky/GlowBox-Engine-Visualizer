...
export type PageSize = 1024 | 2048 | 4096 | 8192 | 16384;
 ...
 */
export function calculateNodeCapacity(pageSize: number): number {
 ...
 */
export function calculateBucketCapacity(pageSize: number): number {
